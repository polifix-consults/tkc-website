  ...
  return (
    ...
    >
      <nav className="max-w-[1400px] mx-auto px-4 md:px-8 flex items-center justify-between h-20 md:h-24">
            ...
            return (
              <li key={link.href}>
                <Link
                  href={link.href}
                  className={cn(
                    "text-sm font-medium text-[#2c2627]/70 hover:text-[#b75f20] transition-colors duration-200",
                    isActive && "text-[#b75f20] border-b border-[#b75f20] pb-1",
                  )}
                >
                  {link.label}
                </Link>
        ...
        {/* Mobile Menu Toggle */}
        <button
          className="md:hidden p-2 text-[#2c2627] hover:text-[#b75f20] transition-colors"
      ...
      <div
        className={cn(
          "md:hidden overflow-hidden transition-all duration-400 bg-white/95 backdrop-blur-md border-b border-black/10",
        ...
        <ul className="px-4 py-6 flex flex-col gap-6">
          {navLinks.map((link) => (
            <li key={link.href}>
              <Link
                href={link.href}
                className="text-base font-medium text-[#2c2627]/80 hover:text-[#b75f20] transition-colors"
