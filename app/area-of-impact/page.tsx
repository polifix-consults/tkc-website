            ...
            <div className="w-full max-w-[1200px] mx-auto px-4 md:px-8 min-w-0">
              <div className="max-w-3xl text-left min-w-0">
                ...
                <h1 className="font-bold tracking-tight text-3xl md:text-5xl text-white mb-5 leading-tight">
                  Empowering young people through chess, strategy and
                  leadership.
                </h1>

                <p className="text-sm md:text-base text-white/90 mb-8 leading-relaxed font-medium max-w-2xl">
                  At the core of our work is a commitment to youth empowerment.
                  We provide young people (ages 6-16) with platforms to develop
                  leadership skills through chess, engage in meaningful
                  discussions, and contribute strategically to real-world
                  solutions. Through mentorship, capacity building, and
                  collaborative initiatives, we are building a generation ready
                  to lead.
                </p>
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="text-center mb-20 animate-fade-up">
            ...
            <h2 className="font-bold text-2xl md:text-3xl text-[#2c2627] tracking-tight mb-4 max-w-3xl mx-auto leading-snug">
              Our Chess programs are designed to equip young people with
              practical skills in leadership, strategy, critical thinking, and
              innovation.
            </h2>
            <div className="h-1 w-16 bg-[#b75f20] rounded-full mx-auto" />
            <p className="text-sm text-[#2c2627]/70 mt-6 max-w-2xl mx-auto leading-relaxed">
              Participants gain hands-on experience, mentorship, and exposure to
              real-world challenges, preparing them to become impactful leaders
              in their communities and beyond. Our programs include:
            </p>
          </div>
                ...
                <div className="flex-1 p-8 md:p-10 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-sm text-[#2c2627]/75 leading-relaxed font-medium mb-6">
                      A strategic and educational, four-week program (2 hours
                      each Saturday) where youth learn chess fundamentals and
                      strategy while building focus, discipline, and confidence.
                      The program is led by experienced facilitators using a
                      structured curriculum. It is ideal for beginners and
                      youths looking to strengthen their skills, with
                      interactive sessions, mentorship, and mini-tournaments.
                    </p>
                  </div>
                  <div>
                    <div className="flex flex-wrap gap-2">
                      {[
                        ...
                        <span
                          key={idx}
                          className="text-xs font-bold px-3 py-1 rounded-full bg-[#f2efe9] text-[#2c2627]/80"
                        >
                          {detail}
                        </span>
                      ))}
                ...
                <div className="flex-1 p-8 md:p-10 flex flex-col justify-between text-white">
                  <div>
                    ...
                    <p className="text-sm text-white/90 leading-relaxed font-medium mb-6">
                      An interdisciplinary learning space where chess meets
                      science, technology, engineering, and mathematics.
                      Participants explore problem-solving, logic, and
                      analytical thinking through hands-on challenges, coding
                      exercises, and innovation-driven activities inspired by
                      chess strategies.
                    </p>
                  </div>
                  <div>
                    <div className="flex flex-wrap gap-2">
                      {[
                        ...
                        <span
                          key={idx}
                          className="text-xs font-bold px-3 py-1 rounded-full bg-white/25 text-white"
                        >
                          {detail}
                        </span>
                      ))}
                ...
                <div className="flex-1 p-8 md:p-10 flex flex-col justify-between text-[#f2efe9]">
                  <div>
                    ...
                    <p className="text-sm text-[#f2efe9]/80 leading-relaxed font-medium mb-6">
                      A high-impact, competitive platform bringing together
                      emerging talents, experienced players, and professionals.
                      This event features tournaments, exhibitions, guest
                      speakers, and networking opportunities designed to expose
                      participants to the professional side of chess and
                  ...
                  <div>
                    <div className="flex flex-wrap gap-2">
                      {[
                        ...
                        <span
                          key={idx}
                          className="text-xs font-bold px-3 py-1 rounded-full bg-white/10 text-[#f2efe9]/90"
                        >
                          {detail}
                        </span>
                      ))}
